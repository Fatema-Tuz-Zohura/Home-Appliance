...
<!--code for dropdown -->
      ...
      <?php
        ...
        <form action="categorynext.php" method="post">
          <!--code for category image and discription for categotynext.php -->
...
<div class="row2" >
  ...
  <br>
        ...
        <div class="col2">
          ...
          <img class="pp_image" src="uploads/<?php echo $row['image'] ?>" alt="Image">
          ...
          <!--code for preorder.php for display everything -->
