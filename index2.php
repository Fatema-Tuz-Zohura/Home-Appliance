...
<div class="header">
    ...
    <div class="header-right" style="font-family: cursive;width: 82%">
...
<!--code for dropdown -->
 ...
 <div class="middle" style="background-color: whitesmoke;height: 640px">

  
 <img src="image/sm1.png" style="height: 650px;
    width: 1345px;
    margin-left: -131px;
    margin-top: -12px;">
