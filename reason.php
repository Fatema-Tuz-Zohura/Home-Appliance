...
<div >
 ...
 <div class="middle">
  ...
  <div class="buy">
   <button class="btn"  type="button" class="submitbtn"><b>Done</b></button></a>  </div>
                              </form>
...
<button style="background-color: white;box-shadow: 0px 0px 10px;margin-left: 814px;
